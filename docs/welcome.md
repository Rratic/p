...
source = "原句似乎来自《空城计》歌词，之后经过网民的不断迭代，有数个版本"
...
## 关于
```hide "为什么要用 Github Pages 这样的静态网页？"
因为买&维护域名、租服务器**要钱**。
```

```hide "为什么这个东西看起来像说明文档一样，为什么不用 <a href='https://github.com/hexojs/hexo'>Hexo</a> 等现成博客模板？"
