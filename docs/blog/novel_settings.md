...
### 主世界地理志
#### 物质界概况
对于物质界的水平面，可以看作对边相互粘合的正方形。上方无限延伸，下方有界。\
在*无穷高处*存在法则产生的日月星辰之像，其上有**永恒灯塔**的成员看守。

光照来自于高处*提前安排*的光子。周期性地，有一段不同朝向、强度不均匀的光子，然后有类似但强度较低的间隔期。\
热量的不均匀产生了风。
