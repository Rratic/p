...
function launch() {
	let container = document.getElementById("cccc");
	let size = Number(document.getElementById("ssss").value);
	let use_ai = Number(document.getElementById("aaaa").value) == 1;
	container.replaceChildren();
	let board = init(64 * size, size, use_ai);
